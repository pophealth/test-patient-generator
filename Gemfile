...
gem 'hqmf-parser', git: 'http://github.com/pophealth/hqmf-parser.git', branch: 'develop'
...
gem 'qrda_generator', git: 'http://github.com/eedrummer/qrda_generator.git', branch: 'master'
